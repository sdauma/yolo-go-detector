# -*- coding: utf-8 -*-
# python_reinforced_benchmark.py
# Python reinforced test - 10 rounds x 200 inferences (YOLO11x)
#
# Technical:
...
#
# Test purpose:
# - Execute 10 rounds x 200 inferences, 20 warmup before each round
# - Record detailed performance indicators for t-test analysis
...
def main():
    print("===== Python Reinforced Test (10 rounds) =====")
    ...
    # Use sum of per-round total inference time (avg_latency * count approximates wall-clock for single-threaded serial scenario)
    ...
    # Save detailed log
    log_path = os.path.join(base_path, "results", "python_reinforced_12threads_detailed_log.txt")
    with open(log_path, 'w', encoding='utf-8') as f:
        f.write("===== Python Reinforced Test Results =====\n")
    ...
    result_path = os.path.join(base_path, "results", "python_reinforced_result.txt")
    with open(result_path, 'w', encoding='utf-8') as f:
        f.write("===== Python Reinforced Test Results (10 rounds) =====\n")
        for i, r in enumerate(results):
    ...
    # Save raw latency data (for analysis)
    latency_data_path = os.path.join(base_path, "results", "python_reinforced_12threads_latency_data.txt")
    ...
    print(f"Raw latency data saved to: {latency_data_path}")
    print("Test complete!")
