# -*- coding: utf-8 -*-
# python_reinforced_benchmark_small.py
# Python reinforced test - small model (YOLO11n) 10 rounds x 200 inferences
#
# Technical:
...
# - Binds first 4 CPU cores (cpu_affinity=[0,1,2,3])
#
# Purpose:
...
# Build model path - use small model YOLO11n
...
def run_benchmark():
    print("===== Python Small Model Reinforced Test ====")

    # Bind CPU cores
    process = psutil.Process(os.getpid())
    process.cpu_affinity([0, 1, 2, 3])
    print("Bound to first 4 CPU cores")
...
def main():
    print("===== Python Small Model Reinforced Test (10 rounds) =====")
    ...
    result_path = os.path.join(base_path, "results", "python_reinforced_small_result.txt")
    with open(result_path, 'w', encoding='utf-8') as f:
        f.write("===== Python Small Model Reinforced Test Results (10 rounds) =====\n")
        for i, r in enumerate(results):
    ...
    latency_data_path = os.path.join(base_path, "results", "python_reinforced_small_latency_data.txt")
