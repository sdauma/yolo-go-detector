...
for num_threads in thread_configs:
    ...
    # Save detailed log
    log_path = os.path.join(current_dir, '..', '..', 'results', f'python_thread_yolo11n_{num_threads}_detailed_log.txt')
    ...
    # Save results
    result_path = os.path.join(current_dir, '..', '..', 'results', f'python_thread_yolo11n_{num_threads}_result.txt')
...
comprehensive_result_path = os.path.join(current_dir, '..', '..', 'results', 'python_thread_config_yolo11n_comprehensive.txt')
